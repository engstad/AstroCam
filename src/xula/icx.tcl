# 
# Project automation script for icx 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source icx.tcl), then you can
...
proc set_process_props {} {
   ...
   project set "User Browsed Strategy Files" "/home/engstad/Electronics/tools/Xilinx/14.7/ISE_DS/ISE/data/default.xds"
   ...
   project set "Target UCF File Name" "/home/engstad/Electronics/proj/FPGA/icx/constraints.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Configuration Rate" "16" -process "Generate Programming File"
   project set "Set SPI Configuration Bus Width" "1" -process "Generate Programming File"
   project set "JTAG Pin TCK" "Float" -process "Generate Programming File"
   ...
   project set "Work Directory" "/home/engstad/Electronics/proj/FPGA/icx/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "main" -process "Generate IBIS Model"
